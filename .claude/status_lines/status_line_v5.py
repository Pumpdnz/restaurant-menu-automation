...
def generate_status_line(input_data):
    ...
    if error:
        # Log the error but show a default message with full session ID
        log_status_line(input_data, f"[{model_name}] [{session_id}] 💭 No session data", error)
        return f"\033[36m[{model_name}]\033[0m \033[33m[{session_id}]\033[0m \033[90m💭 No session data\033[0m"
