...
- IMPORTANT: Initialize agents from each phase in parallel
...
- dayHours: Opening hours as JSON string in object or array format
  - CRITICAL: Check if close time is earlier than open time (e.g., open "11:00" close "03:00" or open "11:00 AM" close "3:00 AM") - this indicates midnight crossing
  - IMPORTANT: For midnight-crossing hours, you MUST split them into two entries per day:
    - Example: "Monday 11:00 AM - 3:00 AM" becomes TWO entries:
      * {"day":"Monday","hours":{"open":"11:00","close":"23:59"}}
      * {"day":"Tuesday","hours":{"open":"00:00","close":"03:00"}}
    - If ALL 7 days have the same midnight-crossing pattern, create 14 entries total (2 per day)
  - Format examples:
    - Standard hours (no midnight crossing): --dayHours='{"Monday":{"open":"11:00","close":"22:00"},"Tuesday":{"open":"11:00","close":"22:00"}}'
    - Complex hours with midnight crossing: --dayHours='[{"day":"Monday","hours":{"open":"11:00","close":"23:59"}},{"day":"Tuesday","hours":{"open":"00:00","close":"03:00"}},{"day":"Tuesday","hours":{"open":"11:00","close":"23:59"}},{"day":"Wednesday","hours":{"open":"00:00","close":"03:00"}}...]'
...
### Phase 4: Menu Configuration & Code Injection (Parallel Execution)
