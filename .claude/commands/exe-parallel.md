...
**CRITICAL: Deploy agents in parallel by calling multiple Task tools in a single response message. Do NOT call Task tools sequentially across multiple messages as this defeats the purpose of parallel execution.**
