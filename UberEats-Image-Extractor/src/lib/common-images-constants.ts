/**
 * Common Menu Item Images Constants
 * Reusable library of common product images for quick selection in menu editor
 * Follow pattern from item-tags-constants.ts
 *
 * Size-aware matching:
 * - containerType: 'can' | 'bottle' | 'large-bottle'
...
export type ContainerType = 'can' | 'bottle' | 'large-bottle';
 ...
 */
export function parseSize(itemName: string): number | null {
 ...
 */
export function getContainerType(sizeML: number | null): ContainerType | null {
...
export const BEVERAGE_IMAGES: CommonImage[] = [
  ...
  // L&P - Can (330ml)
  {
    ...
    aliases: ['L&P', 'Lemon & Paeroa', 'Lemon and Paeroa'],
  ...
  // Karma Cola - Bottle (300ml)
  {
    ...
    aliases: ['Karma Cola', 'Karma', 'Natural Karma Cola', 'Karma Drinks'],
    matchKeywords: ['karma cola', 'karma', 'natural karma cola', 'karma cola bottle', 'karma range', 'karma drinks', 'karma cola range'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'bottle',
    sizeML: 300
  ...
  // Karma Cola - Can (placeholder for future)
  {
    ...
    matchKeywords: ['karma cola can', 'karma cola 330ml'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'can',
    sizeML: 330
  ...
  // Karma Cola Sugar Free - Bottle (300ml)
  {
    ...
    aliases: ['Karma Cola Sugar Free', 'Karma Cola Zero', 'Natural Karma Cola Sugar Free'],
    matchKeywords: ['karma cola sugar free', 'karma cola zero', 'karma zero', 'karma sugar free', 'natural karma cola sugar free'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'bottle',
    sizeML: 300
  ...
  // Karma Cola Sugar Free - Can (placeholder for future)
  {
    ...
    aliases: ['Karma Cola Sugar Free Can', 'Karma Cola Zero Can'],
    matchKeywords: ['karma cola sugar free can', 'karma cola zero can', 'karma zero can'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'can',
    sizeML: 330
  ...
  // Gingerella Ginger Beer - Bottle (300ml)
  {
    ...
    aliases: ['Gingerella', 'Karma Gingerella', 'Organic Gingerella Ginger Beer'],
    matchKeywords: ['gingerella', 'karma ginger beer', 'gingerella ginger beer', 'organic gingerella'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'bottle',
    sizeML: 300
  ...
  // Gingerella Ginger Beer - Can (placeholder for future)
  {
    ...
    category: 'beverage',
    imageUrl: 'PLACEHOLDER_URL_gingerella_can',
    aliases: ['Gingerella Can', 'Karma Gingerella Can'],
    matchKeywords: ['gingerella can', 'karma ginger beer can', 'gingerella 330ml'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'can',
    sizeML: 330
  ...
  // Lemmy Lemonade - Bottle (300ml)
  {
    ...
    aliases: ['Lemmy', 'Karma Lemmy', 'Natural Lemmy Lemonade'],
    matchKeywords: ['lemmy', 'lemmy lemonade', 'karma lemonade', 'natural lemmy', 'karma lemmy'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'bottle',
    sizeML: 300
  ...
  // Lemmy Lemonade - Can (placeholder for future)
  {
    ...
    aliases: ['Lemmy Can', 'Karma Lemmy Can'],
  ...
  // Lemmy Lemonade Sugar Free - Bottle (300ml)
  {
    ...
    aliases: ['Lemmy Sugar Free', 'Lemmy Zero', 'Natural Lemmy Lemonade Sugar Free'],
    matchKeywords: ['lemmy sugar free', 'lemmy zero', 'lemmy lemonade sugar free', 'karma lemonade sugar free'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'bottle',
    sizeML: 300
  ...
  // Lemmy Lemonade Sugar Free - Can (placeholder for future)
  {
    ...
    aliases: ['Lemmy Sugar Free Can', 'Lemmy Zero Can'],
    matchKeywords: ['lemmy sugar free can', 'lemmy zero can', 'lemmy lemonade sugar free can'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'can',
    sizeML: 330
  ...
  // Razza Raspberry Lemonade - Bottle (300ml)
  {
    ...
    aliases: ['Razza', 'Karma Razza', 'Organic Razza Raspberry Lemonade'],
    matchKeywords: ['razza', 'razza raspberry', 'karma raspberry', 'razza raspberry lemonade', 'organic razza'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'bottle',
    sizeML: 300
  ...
  // Razza Raspberry Lemonade - Can (placeholder for future)
  {
    ...
    category: 'beverage',
    imageUrl: 'PLACEHOLDER_URL_razza_can',
    aliases: ['Razza Can', 'Karma Razza Can'],
    matchKeywords: ['razza can', 'razza raspberry can', 'karma raspberry can'],
    confidence: 0.95,
    priorityReplace: true,
    containerType: 'can',
    sizeML: 330
  ...
  {
    id: 'schweppes-llb',
    name: 'Schweppes Lemon Lime & Bitters Bottle',
    category: 'beverage',
  ...
  // Pump Water Bottle (750ml)
  {
    ...
    aliases: ['Pump Water', 'Pump', 'Pump Bottle'],
  ...
  // Red Bull Original - Can
  {
    ...
    aliases: ['Red Bull', 'Red Bull Original'],
  ...
  // Red Bull Watermelon - Can
  {
    ...
    aliases: ['Red Bull Watermelon', 'Red Bull Red Edition'],
...
// ============================================
// SIDE IMAGES (placeholder for future expansion)
// ============================================

export const SIDE_IMAGES: CommonImage[] = [];

// ============================================
// CONDIMENT IMAGES (placeholder for future expansion)
// ============================================

export const CONDIMENT_IMAGES: CommonImage[] = [];
...
// ============================================
// FLAT ARRAY & LOOKUP MAP
// ============================================

export const ALL_COMMON_IMAGES: CommonImage[] = [
  ...BEVERAGE_IMAGES,
  ...SIDE_IMAGES,
  ...CONDIMENT_IMAGES
];

const COMMON_IMAGE_MAP = new Map<string, CommonImage>(
  ALL_COMMON_IMAGES.map(img => [img.id, img])
);
...
/**
 * Get a common image by its ID (O(1) lookup)
 */
export function getCommonImage(imageId: string): CommonImage | null {
  return COMMON_IMAGE_MAP.get(imageId) || null;
}

/**
 * Search common images by query string
 * Returns images matching name, aliases, or keywords
 */
export function searchCommonImages(
  query: string,
  limit: number = 20
): Array<{ image: CommonImage; score: number }> {
  if (!query || !query.trim()) {
    return ALL_COMMON_IMAGES.slice(0, limit).map(img => ({ image: img, score: 0 }));
  }

  const normalized = query.toLowerCase().trim();
  const results: Array<{ image: CommonImage; score: number }> = [];
  ...
  for (const image of ALL_COMMON_IMAGES) {
    ...
    // Name contains query
    else if (image.name.toLowerCase().includes(normalized)) {
      score = 0.9;
    }
    // Alias exact match
    else if (image.aliases.some(a => a.toLowerCase() === normalized)) {
      score = 0.95;
    }
    // Alias contains query
    else if (image.aliases.some(a => a.toLowerCase().includes(normalized))) {
      score = 0.8;
    }
    // Keyword match
 ...
 * Now includes size-aware matching
 */
export function getSuggestedImages(
  itemName: string,
  minConfidence: number = 0.5
): Array<{ image: CommonImage; confidence: number }> {
  if (!itemName || !itemName.trim()) {
    return [];
  }

  const normalized = itemName.toLowerCase().trim();
  const suggestions: Array<{ image: CommonImage; confidence: number }> = [];
  ...
  for (const image of ALL_COMMON_IMAGES) {
    ...
    // NAME CONTAINS (medium confidence)
    ...
    // PARTIAL KEYWORD MATCH (lower confidence)
    else if (image.matchKeywords.some(kw => kw.split(' ').some(word => normalized.includes(word) && word.length > 3))) {
    ...
    // Skip images with placeholder URLs
 ...
 */
export function getImagesByCategory(categoryId: string): CommonImage[] {
  const category = COMMON_IMAGE_CATEGORIES[categoryId];
 ...
 */
export function getActiveCategories(): CommonImageCategory[] {
  return Object.values(COMMON_IMAGE_CATEGORIES).filter(cat => cat.images.length > 0);
}

/**
 * Get images filtered by container type
 */
export function getImagesByContainerType(containerType: ContainerType): CommonImage[] {
  return ALL_COMMON_IMAGES.filter(img => img.containerType === containerType);
}
...
/**
 * Get all images that have valid (non-placeholder) URLs
 */
export function getReadyImages(): CommonImage[] {
  return ALL_COMMON_IMAGES.filter(img => !isPlaceholderUrl(img.imageUrl));
}
