/**
 * Platform detection and configuration utility (ESM version for frontend/Vite)
 *
 * This is a standalone ESM copy of platform-detector.js for frontend builds.
 * The CommonJS version (platform-detector.js) is used by the Node.js server.
 *
 * IMPORTANT: Keep both files in sync when making changes!
 */
