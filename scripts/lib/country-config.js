/**
 * Country Configuration (ES Module version)
 *
 ...
 *
 * Usage (ES Modules - scripts with "type": "module"):
 *   import { COUNTRY_CONFIG, getCountryConfig } from './lib/country-config.js';
 *   const config = getCountryConfig('NZ');
 *   console.log(config.currency); // 'NZD'
 *
 * For CommonJS usage, use country-config.cjs instead.
 */
...
// ES Module exports (for scripts with "type": "module")
export {
  COUNTRY_CONFIG,
  getCountryConfig,
