 ...
 * 
 * This script logs into the admin portal and navigates to Payments settings tab
 * 
 * Usage:
 *   node navigate-to-payments-settings.js --email=<email>
 * 
 * Options:
...
async function navigateToPaymentsSettings() {
  console.log('🚀 Starting Navigation to Payments Settings...\n');
...
// Run the script
navigateToPaymentsSettings().catch(error => {
