 ...
 * 
 * This script logs into the admin portal and navigates to System settings tab
 * 
 * Usage:
 *   node navigate-to-system-settings.js --email=<email>
 * 
 * Options:
...
async function navigateToSystemSettings() {
  console.log('🚀 Starting Navigation to System Settings...\n');
  ...
  try {
    ...
    console.log('\n✅ Successfully navigated to System Settings!');
...
// Run the script
navigateToSystemSettings().catch(error => {
